...
Sitio estático pensado para GitHub Pages y construido con MkDocs Material.
...
3. Lanza `poetry run mkdocs serve` y abre `http://127.0.0.1:8000`.
...
El workflow de GitHub Actions instala Poetry, compila el sitio con MkDocs y publica el resultado en GitHub Pages.
